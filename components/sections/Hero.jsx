        ...
        <div className="grid-hero">
          ...
          <div style={{ width: '100%' }}>
            ...
            <div className={cls('reveal', 'delay-5')} style={{ display: 'flex', alignItems: 'center', gap: '1.25rem', flexWrap: 'wrap' }}>
              ...
              {social.twitter && (
                <a href={social.twitter} target="_blank" rel="noopener noreferrer" aria-label="Twitter / X" className="icon-link">
                  <svg width="18" height="18" fill="currentColor" viewBox="0 0 24 24">
              ...
              {location && (
                <>
                  ...
                  <span style={{ fontSize: '0.8125rem', color: 'var(--text-3)' }}>{location}</span>
                </>
              )}
            </div>
          </div>
