...
export const translations = {
  es: {
    ...
    hero: {
      ...
      tagline:     'Construyo interfaces y soluciones de software enfocadas en usabilidad y rendimiento.',
      bio_p1:      'Estudiante de Ingeniería de Software en la Universidad Cooperativa de Colombia, con formación técnica en Sistemas y Redes. Me apasiona el desarrollo web y el diseño de interfaces que resuelvan problemas reales.',
      bio_p2:      'Trabajo como Diseñador de Software independiente, colaborando en equipos multidisciplinarios, investigando tecnologías y diseñando experiencias de usuario. Soy proactivo y me adapto rápido a nuevos entornos.',
      bio_p3:      'Busco una oportunidad de práctica o trabajo donde pueda aportar, crecer y seguir aprendiendo.',
    },
    about: {
  ...
  en: {
    ...
    hero: {
      ...
      tagline:     'I build interfaces and software solutions focused on usability and performance.',
      bio_p1:      'Software Engineering student at Universidad Cooperativa de Colombia, with a technical background in Systems and Networks. Passionate about web development and designing interfaces that solve real problems.',
      bio_p2:      'I work as a freelance Software Designer, collaborating in multidisciplinary teams, researching technologies and crafting user experiences. I am proactive and adapt quickly to new environments.',
      bio_p3:      'Looking for an internship or job opportunity where I can contribute, grow and keep learning.',
    },
    about: {
